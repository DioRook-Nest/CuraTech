...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_confirm_pass_field=(EditText)findViewById(R.id.reg_cofirm_pass);
        ...
        reg_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(email)&&!TextUtils.isEmpty(password)&&!TextUtils.isEmpty(confirm_password))
                {
                    ...
                    {
                        Toast.makeText(RegisterActivity.this,"confirm password and password doesnt match",Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
    ...
    {
        Intent mainIntent =new Intent(RegisterActivity.this,UMainActivity.class);
