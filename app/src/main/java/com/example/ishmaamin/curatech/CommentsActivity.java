...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profilebtn=findViewById(R.id.comment_prof);
        ...
        Toast.makeText(CommentsActivity.this,blog_post_id,Toast.LENGTH_LONG).show();



        comment_field = findViewById(R.id.comment_field);
        comment_post_btn = findViewById(R.id.comment_pic);
        ...
        firebaseFirestore.collection("Comments/" + blog_post_id + "/Comments")
        ...
        comment_post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Comments/" + blog_post_id + "/Comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    @Override
